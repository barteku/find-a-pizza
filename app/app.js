...
Ext.application({
    startupImage: {
        '320x460': 'res/startup/Default.jpg', // Non-retina iPhone, iPod touch, and all Android devices
        '640x920': 'res/startup/640x920.png', // Retina iPhone and iPod touch
        '640x1096': 'res/startup/640x1096.png', // iPhone 5 and iPod touch (fifth generation)
        '768x1004': 'res/startup/768x1004.png', //  Non-retina iPad (first and second generation) in portrait orientation
        '748x1024': 'res/startup/748x1024.png', //  Non-retina iPad (first and second generation) in landscape orientation
        '1536x2008': 'res/startup/1536x2008.png', // : Retina iPad (third generation) in portrait orientation
        '1496x2048': 'res/startup/1496x2048.png' // : Retina iPad (third generation) in landscape orientation
    },

    isIconPrecomposed: false,
    icon: {
        57: 'res/icons/icon.png',
        72: 'res/icons/icon@72.png',
        114: 'res/icons/icon@2x.png',
        144: 'res/icons/icon@144.png'
    },

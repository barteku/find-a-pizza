...
*/
    Contact.prototype.remove = function(successCB, errorCB) {
        if (this.id == null) {
            ...
            PhoneGap.exec(successCB, errorCB, "com.phonegap.contacts", "remove", [{
                "contact": this
            }]);
        }
    };
...
*/
    Contact.prototype.save = function(successCB, errorCB) {
        ...
        PhoneGap.exec(successCB, errorCB, "com.phonegap.contacts","save", [{
            "contact": cloned
        }]);
    };
 ...
 */
    Notification.prototype.alert = function(message, completeCallback, title, buttonLabel) {
        ...
        PhoneGap.exec(completeCallback, null, "com.phonegap.notification", "alert", [message,{
            "title": _title, 
